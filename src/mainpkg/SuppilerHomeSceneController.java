 ...
 * @author ERAJ
 */
public class SuppilerHomeSceneController implements Initializable {

    @FXML
    private Button supReceiveOrderButton;
    @FXML
    private Button supCheckDeliveryStatButton;
    @FXML
    ...
    @FXML
    private void supReceiveOrderButtonOnClick(ActionEvent event) {
    }
    ...
    @FXML
    private void supCheckDeliveryStatButtonOnClick(ActionEvent event) {
    }
